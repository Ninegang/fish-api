...
var Main = (function (_super) {
    ...
    function Main() {
        ...
        _this = _super.call(this, LoadingUI, "default_" + uiCore.LangUtils.getLangType() + ".res.json" + "?v=" + LibCore.GameConfig.version, LibCore.GameConfig.RES, "default.thm.json" + "?v=" + LibCore.GameConfig.version, ["preload"], uiCore.Loadding) || this;
        return _this;
    }
    ...
    Main.prototype.initLocalStorage = function () {
        ...
        // console.log(LinkUrl);
        var accountName = uiCore.Utils.getQueryString("AccountName");
        var token = uiCore.Utils.getQueryString("Token");
        var gid = (uiCore.Utils.getQueryString("GameID") == null ? uiCore.Application.currGameId : parseInt(uiCore.Utils.getQueryString("GameID")));
        var agent = uiCore.Utils.getQueryString("AgentID");
        var nickName = uiCore.Utils.getQueryString("NickName");
        var iconid = uiCore.Utils.getQueryString("SystemIconID");
        var passward = uiCore.Utils.getQueryString("Password");
        var viplever = uiCore.Utils.getQueryString("Viplevel");
        var ischange = 0;
        var userID = uiCore.Utils.getQueryString("UserID");
        var userType = uiCore.Utils.getQueryString("UserType");
        var bankGoldNum = 0;
        var money = uiCore.Utils.getQueryString("Money");
        var playerHeadId = uiCore.Utils.getQueryString("icon");
        // console.log(urlData);
    ...
    //发生错误断开连接
    Main.prototype.onConnectFail = function () {
    ...
    Main.prototype.ChangeMainSceneView = function () {
        SceneManager.changeSceneView(MainSceneView);
    };
    Main.prototype.ChangeRoomScaneView = function () {

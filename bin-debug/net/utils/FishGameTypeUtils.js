...
var Net;
(function (Net) {
    var FishGameTypeUtils = (function () {
        function FishGameTypeUtils() {
        }
        FishGameTypeUtils.getFishGameTypeStr = function (type, isRequest) {
            var endStr = "request";
            if (!isRequest) {
                endStr = "response";
            }
        ...
        return FishGameTypeUtils;
    }());
    Net.FishGameTypeUtils = FishGameTypeUtils;
    __reflect(FishGameTypeUtils.prototype, "Net.FishGameTypeUtils");
})(Net || (Net = {}));
//# sourceMappingURL=FishGameTypeUtils.js.map
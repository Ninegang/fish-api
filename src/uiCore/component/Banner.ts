    ...
    export class Banner extends eui.Component {
    	...
    	*/
        ...
        public constructor(message: string, okHandler?: Function, thisObject?: any) {
            super();
            this.skinName = uiCore.Banner.skinName;
        ...
        */
        public static show(message: string, okHandler?: Function, thisObject?: any): uiCore.Banner {
            if (!this.skinName) {
                warn("Banner标语未初始化，将不会被显示，请先调用uiCore.Banner.init()。");
            }
            var banner: uiCore.Banner = new uiCore.Banner(message, okHandler, thisObject);

namespace uiCore {
	 ...
	 *
	 */
    export class CheckBox extends eui.CheckBox {
        ...
        public soundPath: string = "touch_mp3";
        /*是否需要缩放*/
        ...
        private onTouchOutSide(e: egret.TouchEvent): void {
            ...
            if (this.stage && this.stage.contains(CheckBox._mask) && e.target.hitTestPoint(e.stageX, e.stageY)) {//是自己加的遮罩并且点击的是按钮区域，需要发一次egret.TouchEvent.TOUCH_TAP事件
